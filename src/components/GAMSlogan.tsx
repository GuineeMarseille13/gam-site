      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <a
              href="#"
              className="group flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-white/80 hover:bg-blue-50 rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110"
              aria-label="Facebook"
            >
              <svg
            ...
            <a
              href="#"
              className="group flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-white/80 hover:bg-pink-50 rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110"
            ...
            >
              <svg
                className="w-6 h-6 text-gray-600 group-hover:text-blue-700 transition-colors"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <a
              href="#"
              className="group flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-white/80 hover:bg-red-50 rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110"
              aria-label="YouTube"
            >
              <svg
            ...
            <a
              href="#"
              className="group flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-white/80 hover:bg-green-50 rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110"
              aria-label="WhatsApp"
            >
              <svg
