...
function PartnerCardSkeleton({ index }: { index: number }) {
  ...
  return (
    <div className="group relative w-full py-2">
      ...
      >
        <div className="relative flex h-auto flex-col overflow-hidden rounded-2xl bg-white sm:h-[450px]">
          <div
            className={cn(
          ...
          <div className="relative aspect-[16/10] shrink-0 overflow-hidden bg-gradient-to-br from-slate-50 via-muted/40 to-slate-100/90 sm:aspect-auto sm:h-[240px]">
          ...
          <div className="flex flex-col justify-between bg-gradient-to-b from-white to-gray-50/50 p-5 sm:min-h-0 sm:flex-1 sm:p-6">
            <div className="flex flex-col gap-2 sm:min-h-0 sm:flex-1">
              <PulseBar className="h-6 w-[90%] shrink-0 rounded-md sm:h-8 sm:w-[85%]" />
              <div className="space-y-2 sm:min-h-0 sm:flex-1">
                <PulseBar className="h-3.5 w-full rounded-sm sm:h-4" />
                <PulseBar className="h-3.5 w-[88%] rounded-sm sm:h-4" />
                <PulseBar className="h-3.5 w-[72%] rounded-sm sm:hidden sm:h-4" />
              </div>
              <PulseBar className="h-3 w-24 shrink-0 rounded-sm" />
            </div>

            <div className="mt-3 flex min-h-[44px] shrink-0 items-center gap-2 sm:mt-4" aria-hidden>
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <PulseBar className="mx-auto mb-4 h-9 max-w-[min(100%,20rem)] rounded-lg sm:h-11 md:h-12 md:max-w-[28rem]" />
      ...
      <div className="relative z-10 -mx-4 mt-6 sm:mx-0 sm:mt-10 md:mt-12">
        <div className="relative mx-auto w-full max-w-[100rem] px-0 sm:px-6 lg:px-8">
          <div className="overflow-hidden px-4 py-4 sm:px-0 sm:py-6">
            <div className="flex justify-center gap-6 sm:gap-8 md:justify-start md:overflow-hidden lg:gap-10">
