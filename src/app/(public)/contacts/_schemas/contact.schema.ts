...
export const contactFormSchema = z.object({
  firstName: z
    .string({ message: MESSAGES.formValidation.firstName.required })
  ...
  lastName: z
    .string({ message: MESSAGES.formValidation.lastName.required })
  ...
  email: z
    .string({ message: MESSAGES.formValidation.email.required })
  ...
  phone: z
    ...
    .or(z.literal("")),
  subject: z
    .string({ message: MESSAGES.formValidation.subject.required })
  ...
  message: z
    .string({ message: MESSAGES.formValidation.message.required })
