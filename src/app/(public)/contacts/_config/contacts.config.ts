...
export const STYLE_CONFIG = {
  ...
  contactInfo: {
    ...
    card:
      "group relative flex h-full w-full flex-col rounded-3xl bg-white p-4 shadow-[inset_0_1px_0_0_rgb(255_255_255/0.9),0_0_0_1px_rgb(148_163_184/0.07),0_1px_2px_-1px_rgb(15_23_42/0.04),0_8px_24px_-6px_rgb(15_23_42/0.08),0_24px_56px_-14px_rgb(15_23_42/0.07),0_48px_96px_-28px_rgb(15_23_42/0.06)] transition-[box-shadow] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:shadow-[inset_0_1px_0_0_rgb(255_255_255/0.95),0_0_0_1px_rgb(148_163_184/0.1),0_2px_6px_-2px_rgb(15_23_42/0.05),0_14px_36px_-8px_rgb(15_23_42/0.12),0_36px_72px_-16px_rgb(15_23_42/0.1),0_64px_120px_-32px_rgb(24_24_27/0.1)] sm:p-6",
    icon:
      "mb-3 inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br shadow-[inset_0_1px_0_0_rgb(255_255_255/0.65),0_1px_2px_rgb(15_23_42/0.04),0_6px_16px_-4px_rgb(15_23_42/0.12),0_14px_32px_-8px_rgb(15_23_42/0.08)] transition-transform duration-300 group-hover:scale-110 sm:h-14 sm:w-14",
    socialGrid: "flex flex-wrap items-center justify-center gap-3 sm:gap-4",
    socialButton:
      "group relative inline-flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br text-white transition-[box-shadow] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] shadow-[inset_0_1px_0_0_rgb(255_255_255/0.28),0_0_0_1px_rgb(255_255_255/0.1),0_2px_4px_-1px_rgb(15_23_42/0.14),0_8px_18px_-4px_rgb(15_23_42/0.2),0_16px_36px_-10px_rgb(15_23_42/0.14),0_28px_56px_-14px_rgb(24_24_27/0.12)] hover:shadow-[inset_0_1px_0_0_rgb(255_255_255/0.38),0_0_0_1px_rgb(255_255_255/0.14),0_4px_8px_-2px_rgb(15_23_42/0.12),0_12px_28px_-6px_rgb(15_23_42/0.22),0_24px_48px_-12px_rgb(15_23_42/0.18),0_40px_72px_-18px_rgb(9_9_11/0.16)] sm:h-14 sm:w-14",
  },
  form: {
    wrapper:
      "mx-auto w-full min-w-0 max-w-3xl rounded-3xl bg-gradient-to-br from-zinc-200 via-neutral-300 to-slate-500 p-[2px] transition-[box-shadow] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] shadow-[inset_0_1px_0_0_rgb(255_255_255/0.35),0_0_0_1px_rgb(113_113_122/0.22),0_2px_4px_-2px_rgb(15_23_42/0.05),0_12px_32px_-8px_rgb(15_23_42/0.14),0_32px_72px_-16px_rgb(15_23_42/0.08),0_56px_112px_-28px_rgb(24_24_27/0.12)] hover:shadow-[inset_0_1px_0_0_rgb(255_255_255/0.45),0_0_0_1px_rgb(63_63_70/0.28),0_4px_8px_-4px_rgb(15_23_42/0.06),0_18px_48px_-10px_rgb(15_23_42/0.18),0_44px_88px_-18px_rgb(15_23_42/0.1),0_72px_140px_-32px_rgb(9_9_11/0.14)]",
    container:
    ...
    badge:
      "inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-zinc-800 to-slate-900 text-white shadow-lg shadow-zinc-300/50",
    ...
    inputValid:
      "border-gray-300 focus:ring-zinc-300 focus:border-zinc-600 hover:border-zinc-400",
    textarea: "resize-none",
    error: "text-xs text-red-600 mt-1 flex items-center gap-1.5",
    submitButton:
      "w-full sm:w-auto inline-flex items-center justify-center gap-3 rounded-full px-8 py-4 bg-gradient-to-r from-zinc-800 via-slate-900 to-zinc-900 text-white font-bold text-base sm:text-lg shadow-xl hover:shadow-2xl hover:from-zinc-900 hover:via-slate-950 hover:to-black ring-1 ring-white/10 cursor-pointer transition-all duration-300",
    submitButtonDisabled: "opacity-50 cursor-not-allowed",
  },
  success: {
    container: "max-w-3xl mx-auto px-4 py-12 sm:py-16 text-center",
    icon: "inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-zinc-100 to-neutral-50 text-zinc-800 shadow-lg shadow-zinc-200/80",
    title:
      "mt-6 text-3xl sm:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-zinc-700 via-slate-900 to-zinc-950 bg-clip-text text-transparent",
    message:
