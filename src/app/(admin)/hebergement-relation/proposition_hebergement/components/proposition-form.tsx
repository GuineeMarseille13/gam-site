    ...
    <form action={action} className="space-y-6 max-w-xl">
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full h-10 rounded-xl border border-border bg-background px-3 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-emerald-500"
        >
      ...
      <div className="flex flex-wrap items-center gap-3">
        <SubmitButton className="h-10 rounded-xl px-5 text-sm font-semibold bg-emerald-600 hover:bg-emerald-700 text-white">
          {submitLabel}
        </SubmitButton>
