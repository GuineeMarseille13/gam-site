...
import { IconPhoto, IconUpload, IconX, IconLink, IconEye, IconEyeOff } from "@tabler/icons-react"
      ...
      <div className="grid gap-6 lg:grid-cols-5 lg:gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="sticky top-6 space-y-3">
            <p className="text-sm font-medium text-foreground">Logo du partenaire</p>
