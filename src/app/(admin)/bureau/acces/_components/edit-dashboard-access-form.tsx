...
interface EditDashboardAccessFormProps {
  defaultEmail: string
  defaultRole: string
...
/**
 * Modifie le rôle, l’email de connexion et éventuellement le mot de passe d’un accès.
 */
export function EditDashboardAccessForm({
  defaultEmail,
  defaultRole,
  personLabel,
  profileKind,
  action,
}: EditDashboardAccessFormProps) {
          ...
          <div className="space-y-8 px-5 py-8 sm:px-8">
            <section className="space-y-4">
              <AccessSectionTitle
                kicker="Connexion"
                title="Identifiants"
                description="Email et rôle d'accès au dashboard."
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Button
                type="submit"
                disabled={isPending}
                className="min-w-[160px] gap-2 rounded-xl bg-amber-500 text-white shadow-md shadow-amber-500/25 hover:bg-amber-600"
              >
                {isPending ? (
                  <>
