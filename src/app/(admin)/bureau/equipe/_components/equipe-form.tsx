      ...
      <div className="grid gap-6 lg:grid-cols-5 lg:gap-8">
        ...
        <div className="space-y-5 lg:col-span-3">
            ...
            <div className="space-y-1.5">
              ...
              {mode === "edit" && hasUser && (
                <p className="text-[11px] text-muted-foreground/70">
                  Compte dashboard lié — modifiez l&apos;accès depuis la page{" "}
                  <a href="/bureau/acces" className="font-medium text-amber-600 underline-offset-2 hover:underline dark:text-amber-400">
                    Accès
                  </a>
                  .
                </p>
              ...
              {mode === "create" && (
                <p className="text-[11px] text-muted-foreground/70">
                  Pour un accès au dashboard, créez l&apos;accès ensuite depuis{" "}
                  <a href="/bureau/acces/nouveau" className="font-medium text-amber-600 underline-offset-2 hover:underline dark:text-amber-400">
                    Accès → Nouvel accès
                  </a>
                  .
                </p>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={posteCode} onValueChange={setPosteCode}>
