...
export const metadata: Metadata = {
  title: "Statistiques — Accompagnement administratif",
  description: "Section « Statistiques » — contenu sur DetailsPole",
}

export default async function DemarcheAdministrativeStatistiquesPage() {
  ...
  return (
    <BureauContent
      title="Statistiques"
      description="Texte libre sous le titre « Statistiques » sur la page publique (les chiffres restent issus des données statiques du site)."
