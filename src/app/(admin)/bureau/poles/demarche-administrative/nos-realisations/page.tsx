...
export const metadata: Metadata = {
  title: "Nos réalisations — Accompagnement administratif",
  description: "Section « Nos réalisations » — contenu sur DetailsPole",
}

export default async function DemarcheAdministrativeNosRealisationsPage() {
