...
export const metadata: Metadata = {
  title: "À propos — Événementiel",
  description: "Modifier le texte « À propos » sur la page publique du pôle événementiel",
}

export default async function EvenementielTitrePage() {
  ...
  return (
    <BureauContent
      ...
      description="Texte affiché sur la page publique du pôle événementiel"
